    ...
    <footer>
      <div class="footer-content">
        <div class="footer-row">
          ...
          <span class="footer-separator">•</span>
          <span class="footer-text">&copy; ${new Date().getFullYear()} <a href="https://www.github.com/darthvader58/numericle" target="_blank" rel="noopener noreferrer" class="footer-link">Numericle</a>, All Rights Reserved</span>
        </div>
      </div>
    </footer>
  `;
